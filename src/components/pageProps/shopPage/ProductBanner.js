  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
        ...
        <span
          className={`${
            girdViewActive
              ...
              : "border-[1px] border-gray-300 text-[#4B5563]"
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#4B5563] relative">
        ...
        <div className="flex items-center gap-2 text-[#4B5563] relative">
